...
import com.caij.puremusic.databinding.PreferenceDialogLibraryCategoriesListitemBinding
...
import com.caij.puremusic.util.SwipeAndDragHelper
import com.caij.puremusic.util.SwipeAndDragHelper.ActionCompletionContract
...
class CategoryInfoAdapter : RecyclerView.Adapter<CategoryInfoAdapter.ViewHolder>(),
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val category = PreferenceUtil.findCategory(categoryInfo.categoryId)
        if (category != null) {
            holder.binding.title.text =
                holder.binding.title.resources.getString(category.stringRes)
        }
