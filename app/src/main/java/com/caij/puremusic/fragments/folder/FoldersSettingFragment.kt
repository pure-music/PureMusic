...
import com.caij.puremusic.databinding.FragmentFolderSettingBinding
...
import com.caij.puremusic.views.BreadCrumbLayout.Crumb
import com.caij.puremusic.views.BreadCrumbLayout.SelectionCallback
...
class FoldersSettingFragment : Fragment(R.layout.fragment_folder_setting),
    IMainActivityFragmentCallbacks, SelectionCallback, ICallbacks,
    LoaderManager.LoaderCallbacks<List<File>>, StorageClickListener, MenuProvider {
    private var _binding: FragmentFolderSettingBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentFolderSettingBinding.bind(view)
                ...
                listSongs(
                    ...
                    if (songs.isNotEmpty()) {
                        ...
                        if (startIndex > -1) {
                            ...
                            Snackbar.make(binding.root, String.format(
...
//        )
    ...
    private class AsyncFileLoader(foldersFragment: FoldersSettingFragment) :
        WrappedAsyncTaskLoader<List<File>>(foldersFragment.requireActivity()) {
        private val fragmentWeakReference: WeakReference<FoldersSettingFragment> =
    ...
    private fun switchToFileAdapter() {
        adapter = SongFileAdapter(requireActivity() as AppCompatActivity, LinkedList(), R.layout.item_list, this)
    ...
    companion object {
        val TAG: String = FoldersSettingFragment::class.java.simpleName
