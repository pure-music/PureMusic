...
import com.caij.puremusic.databinding.FragmentMd3PlayerBinding
...
class MD3PlayerFragment : AbsPlayerFragment(R.layout.fragment_md3_player) {
    ...
    override fun onColorChanged(color: MediaNotificationProcessor) {
        ...
        tintChild(binding.includePlayMenu.root, ATHUtil.resolveColor(requireContext(), androidx.appcompat.R.attr.colorControlNormal))
    }
