...
import com.caij.puremusic.adapter.ContributorAdapter
import com.caij.puremusic.databinding.FragmentAboutBinding
import com.caij.puremusic.extensions.openUrl
import com.caij.puremusic.fragments.LibraryViewModel
import com.caij.puremusic.util.NavigationUtil.openPrivacy
...
class AboutFragment : Fragment(R.layout.fragment_about), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().title = getString(R.string.action_about)
    }
    ...
    private fun setUpView() {
        ...
        binding.aboutContent.cardOther.privacy.setOnClickListener(this)
    }
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.appRate -> openUrl(String.format(Constants.RATE_ON_GOOGLE_PLAY, requireActivity().packageName))
