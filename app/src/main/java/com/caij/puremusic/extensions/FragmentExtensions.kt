...
//    val hostFragment = supportFragmentManager.findFragmentById(navHostId)
//    val navHostFragment: NavHostFragment = hostFragment as NavHostFragment
...
fun AbsMainActivityFragment.setupToolbar(toolbar: Toolbar) {
