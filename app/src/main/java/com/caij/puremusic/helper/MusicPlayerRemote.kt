...
import com.caij.puremusic.extensions.equalsCompat
...
object MusicPlayerRemote : KoinComponent {
    ...
    private fun tryToHandleOpenPlayingQueue(
        ...
        if (playingQueue.equalsCompat(queue)) {
            if (startPlaying) {
        ...
        if (musicService != null) {
            ...
            if (uri.scheme != null && uri.authority != null) {
                if (uri.scheme == ContentResolver.SCHEME_CONTENT) {
                    ...
                    if (songId != null) {
                        songs = songRepository.searchSongsByTitle(songId)
                    }
                }
            }
            ...
            if (songs != null && songs.isNotEmpty()) {
                ...
                try {
                    musicService?.showToast(R.string.unplayable_file)
                } catch (e: Exception) {
