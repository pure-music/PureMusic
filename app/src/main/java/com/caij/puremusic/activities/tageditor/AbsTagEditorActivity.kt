...
import com.caij.puremusic.extensions.hideSoftKeyboard
...
abstract class AbsTagEditorActivity<VB : ViewBinding> : AbsBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            this@AbsTagEditorActivity.songPaths = getSongPaths()
    ...
    private fun writeToFiles(songUris: List<Uri>, cacheFiles: List<File>) {
        ...
        lifecycleScope.launch {
            ...
            TagWriter.scan(this@AbsTagEditorActivity, songPaths)
        }
    }
