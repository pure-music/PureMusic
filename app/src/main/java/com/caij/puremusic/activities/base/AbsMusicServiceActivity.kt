...
import com.caij.puremusic.db.toPlayCount
...
import com.caij.puremusic.service.MusicService.Companion.FAVORITE_STATE_CHANGED
import com.caij.puremusic.service.MusicService.Companion.MEDIA_STORE_CHANGED
import com.caij.puremusic.service.MusicService.Companion.META_CHANGED
import com.caij.puremusic.service.MusicService.Companion.PLAY_STATE_CHANGED
import com.caij.puremusic.service.MusicService.Companion.QUEUE_CHANGED
import com.caij.puremusic.service.MusicService.Companion.REPEAT_MODE_CHANGED
import com.caij.puremusic.service.MusicService.Companion.SHUFFLE_MODE_CHANGED
    ...
    override fun onPlayingMetaChanged() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (songs.isNotEmpty()) {
                ...
                val newSong = PlayCountEntity(song.songId, System.currentTimeMillis(), song.playCount + 1)
                repository.updateSongInPlayCount(newSong)
            } else {
