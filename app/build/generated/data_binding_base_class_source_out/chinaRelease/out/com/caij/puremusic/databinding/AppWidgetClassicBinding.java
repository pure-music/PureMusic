...
public final class AppWidgetClassicBinding implements ViewBinding {
  ...
  private AppWidgetClassicBinding(@NonNull LinearLayout rootView, @NonNull ImageButton buttonNext,
  ...
  public static AppWidgetClassicBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppWidgetClassicBinding((LinearLayout) rootView, buttonNext, buttonPrev,
