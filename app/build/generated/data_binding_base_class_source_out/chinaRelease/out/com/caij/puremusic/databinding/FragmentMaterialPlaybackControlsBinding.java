...
public final class FragmentMaterialPlaybackControlsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMaterialPlaybackControlsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMaterialPlaybackControlsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMaterialPlaybackControlsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_material_playback_controls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMaterialPlaybackControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMaterialPlaybackControlsBinding((ConstraintLayout) rootView, nextButton,
