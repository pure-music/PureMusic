...
public final class FragmentAdaptivePlayerPlaybackControlsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAdaptivePlayerPlaybackControlsBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentAdaptivePlayerPlaybackControlsBinding inflate(
  ...
  public static FragmentAdaptivePlayerPlaybackControlsBinding inflate(
    ...
    View root = inflater.inflate(R.layout.fragment_adaptive_player_playback_controls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAdaptivePlayerPlaybackControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAdaptivePlayerPlaybackControlsBinding((ConstraintLayout) rootView,
          nextButton, playPauseButton, previousButton, progressSlider, repeatButton, shuffleButton,
          songCurrentProgress, songInfo, songTotalTime, volumeFragmentContainer);
    }
