...
public final class FragmentSimpleControlsFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentSimpleControlsFragmentBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentSimpleControlsFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSimpleControlsFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_simple_controls_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSimpleControlsFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSimpleControlsFragmentBinding((ConstraintLayout) rootView, nextButton,
          playPauseButton, previousButton, repeatButton, shuffleButton, songCurrentProgress,
          songInfo, text, title, volumeFragmentContainer);
    }
