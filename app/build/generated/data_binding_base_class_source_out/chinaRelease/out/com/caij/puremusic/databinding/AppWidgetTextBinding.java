...
public final class AppWidgetTextBinding implements ViewBinding {
  @NonNull
  ...
  private AppWidgetTextBinding(@NonNull LinearLayout rootView, @NonNull ImageButton buttonNext,
  ...
  @NonNull
  public static AppWidgetTextBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AppWidgetTextBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.app_widget_text, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AppWidgetTextBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppWidgetTextBinding((LinearLayout) rootView, buttonNext, buttonPrev,
          buttonTogglePlayPause, mediaActions, mediaTitles, text, title);
    }
