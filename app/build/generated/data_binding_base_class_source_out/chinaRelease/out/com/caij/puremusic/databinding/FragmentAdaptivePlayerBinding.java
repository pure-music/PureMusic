...
public final class FragmentAdaptivePlayerBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAdaptivePlayerBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentAdaptivePlayerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAdaptivePlayerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_adaptive_player, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAdaptivePlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAdaptivePlayerBinding((FrameLayout) rootView, coverLyrics,
