...
public final class FragmentGradientControlsBinding implements ViewBinding {
  ...
  private FragmentGradientControlsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull Slider progressSlider, @NonNull MaterialTextView songCurrentProgress,
  ...
  @NonNull
  public static FragmentGradientControlsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentGradientControlsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_gradient_controls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentGradientControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGradientControlsBinding((ConstraintLayout) rootView, nextButton,
          playPauseButton, playerMenu, previousButton, progressSlider, songCurrentProgress,
          songFavourite, songInfo, songTotalTime, text, title, titleContainer,
