...
public final class FragmentColorPlayerPlaybackControlsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentColorPlayerPlaybackControlsBinding(@NonNull ConstraintLayout rootView,
      @NonNull SimpleLrcView lyricsView2, @NonNull AppCompatImageButton nextButton,
      @NonNull FloatingActionButton playPauseButton, @NonNull AppCompatImageButton previousButton,
  ...
  @NonNull
  public static FragmentColorPlayerPlaybackControlsBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static FragmentColorPlayerPlaybackControlsBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.fragment_color_player_playback_controls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentColorPlayerPlaybackControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentColorPlayerPlaybackControlsBinding((ConstraintLayout) rootView,
          lyricsView2, nextButton, playPauseButton, previousButton, progressSlider, repeatButton,
