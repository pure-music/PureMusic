...
public final class FragmentSimplePlayerBinding implements ViewBinding {
  ...
  private FragmentSimplePlayerBinding(@NonNull View rootView,
  ...
  @NonNull
  public static FragmentSimplePlayerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSimplePlayerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_simple_player, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSimplePlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSimplePlayerBinding(rootView, binding_includePlayMenu,
