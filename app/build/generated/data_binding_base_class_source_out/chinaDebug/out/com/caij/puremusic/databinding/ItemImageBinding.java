...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatImageView image,
      @NonNull MaterialCardView imageContainer, @NonNull MaterialTextView title) {
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemImageBinding((ConstraintLayout) rootView, image, imageContainer, title);
    }
