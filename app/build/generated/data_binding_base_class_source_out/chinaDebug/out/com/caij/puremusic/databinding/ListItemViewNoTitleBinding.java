...
public final class ListItemViewNoTitleBinding implements ViewBinding {
  @NonNull
  ...
  private ListItemViewNoTitleBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ListItemViewNoTitleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListItemViewNoTitleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_item_view_no_title, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListItemViewNoTitleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemViewNoTitleBinding((ConstraintLayout) rootView, guidelineFrontMargin, icon,
          title);
    }
