...
public final class FragmentFitPlaybackControlsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFitPlaybackControlsBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageButton nextButton, @NonNull FloatingActionButton playPauseButton,
      @NonNull AppCompatImageButton previousButton, @NonNull ConstraintLayout progressContainer,
  ...
  @NonNull
  public static FragmentFitPlaybackControlsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFitPlaybackControlsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_fit_playback_controls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFitPlaybackControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFitPlaybackControlsBinding((ConstraintLayout) rootView, nextButton,
