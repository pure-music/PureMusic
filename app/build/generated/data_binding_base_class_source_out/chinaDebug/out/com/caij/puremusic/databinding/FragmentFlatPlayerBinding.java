...
public final class FragmentFlatPlayerBinding implements ViewBinding {
  ...
  private FragmentFlatPlayerBinding(@NonNull View rootView, @NonNull View colorGradientBackground,
  ...
  public static FragmentFlatPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFlatPlayerBinding(rootView, colorGradientBackground,
