...
public final class AppWidgetCardBinding implements ViewBinding {
  ...
  private AppWidgetCardBinding(@NonNull LinearLayout rootView, @NonNull ImageButton buttonNext,
  ...
  @NonNull
  public static AppWidgetCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AppWidgetCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.app_widget_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AppWidgetCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppWidgetCardBinding((LinearLayout) rootView, buttonNext, buttonPrev,
          buttonTogglePlayPause, image, mediaActions, mediaTitles, text, title);
    }
