...
public final class AppWidgetSmallBinding implements ViewBinding {
  ...
  private AppWidgetSmallBinding(@NonNull GridLayout rootView, @NonNull ImageButton buttonNext,
      ...
      @NonNull LinearLayout mediaTitles, @NonNull TextView text, @NonNull TextView textSeparator,
  ...
  public static AppWidgetSmallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppWidgetSmallBinding((GridLayout) rootView, buttonNext, buttonPrev,
          buttonTogglePlayPause, image, mediaActions, mediaTitles, text, textSeparator, title);
    }
