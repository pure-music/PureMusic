...
public final class FragmentFullPlayerControlsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFullPlayerControlsBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageButton nextButton, @NonNull FloatingActionButton playPauseButton,
      @NonNull AppCompatImageView playerMenu, @NonNull AppCompatImageButton previousButton,
      @NonNull Slider progressSlider, @NonNull AppCompatImageButton repeatButton,
      @NonNull AppCompatImageButton shuffleButton, @NonNull MaterialTextView songCurrentProgress,
      @NonNull AppCompatImageView songFavourite, @NonNull MaterialTextView songInfo,
  ...
  @NonNull
  public static FragmentFullPlayerControlsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFullPlayerControlsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_full_player_controls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFullPlayerControlsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.playerMenu;
      AppCompatImageView playerMenu = ViewBindings.findChildViewById(rootView, id);
      if (playerMenu == null) {
        break missingId;
      }
      ...
      return new FragmentFullPlayerControlsBinding((ConstraintLayout) rootView, nextButton,
          playPauseButton, playerMenu, previousButton, progressSlider, repeatButton, shuffleButton,
          songCurrentProgress, songFavourite, songInfo, songTotalTime, text, title, titleContainer,
