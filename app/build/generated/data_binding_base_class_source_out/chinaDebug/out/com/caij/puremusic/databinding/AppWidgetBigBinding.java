...
public final class AppWidgetBigBinding implements ViewBinding {
  ...
  private AppWidgetBigBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton buttonNext,
      @NonNull ImageButton buttonPrev, @NonNull ImageButton buttonTogglePlayPause,
      @NonNull FrameLayout clickableArea, @NonNull ImageView image,
      @NonNull LinearLayout mediaActions, @NonNull LinearLayout mediaTitles, @NonNull TextView text,
  ...
  @NonNull
  public static AppWidgetBigBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AppWidgetBigBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.app_widget_big, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AppWidgetBigBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout clickableArea = ViewBindings.findChildViewById(rootView, id);
      ...
      return new AppWidgetBigBinding((RelativeLayout) rootView, buttonNext, buttonPrev,
          buttonTogglePlayPause, clickableArea, image, mediaActions, mediaTitles, text, title);
    }
