...
public final class FragmentPlainControlsFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPlainControlsFragmentBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentPlainControlsFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPlainControlsFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_plain_controls_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPlainControlsFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlainControlsFragmentBinding((ConstraintLayout) rootView, nextButton,
