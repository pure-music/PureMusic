...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatImageView dragView,
      @NonNull AppCompatImageView image, @NonNull MaterialTextView imageText,
      @NonNull MaterialCardView imageTextContainer, @NonNull AppCompatImageView menu,
      @NonNull MaterialTextView text, @Nullable MaterialTextView text2,
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListBinding((ConstraintLayout) rootView, dragView, image, imageText,
