...
public class GlideRequests extends RequestManager {
  ...
  public GlideRequest<BitmapPaletteWrapper> asBitmapPalette() {
    return (GlideRequest<BitmapPaletteWrapper>) RetroGlideExtension.asBitmapPalette(this.as(BitmapPaletteWrapper.class));
  }
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.caij.puremusic.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.caij.puremusic.glide.GlideOptions().apply(toSet));
    }
  }
}
