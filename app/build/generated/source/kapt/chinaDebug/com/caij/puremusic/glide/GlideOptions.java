...
public final class GlideOptions extends RequestOptions implements Cloneable {
  ...
  /**
   * @see RetroGlideExtension#artistImageOptions(BaseRequestOptions, Object)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions artistImageOptions(@NotNull Object o) {
    return (GlideOptions) RetroGlideExtension.artistImageOptions(this, o);
  }

  /**
   * @see RetroGlideExtension#songCoverOptions(BaseRequestOptions, Song, Object)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions songCoverOptions(@NotNull Song song,
      @org.jetbrains.annotations.Nullable Object o) {
    return (GlideOptions) RetroGlideExtension.songCoverOptions(this, song, o);
  }

  /**
   * @see RetroGlideExtension#simpleSongCoverOptions(BaseRequestOptions, Song, Object)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions simpleSongCoverOptions(@NotNull Song song,
      @org.jetbrains.annotations.Nullable Object o) {
    return (GlideOptions) RetroGlideExtension.simpleSongCoverOptions(this, song, o);
  }

  /**
   * @see RetroGlideExtension#albumCoverOptions(BaseRequestOptions, Album, Object)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions albumCoverOptions(@NotNull Album album,
      @org.jetbrains.annotations.Nullable Object o) {
    return (GlideOptions) RetroGlideExtension.albumCoverOptions(this, album, o);
  }

  /**
   * @see RetroGlideExtension#userProfileOptions(BaseRequestOptions, File, Context)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions userProfileOptions(@NotNull File file, @NotNull Context context) {
    return (GlideOptions) RetroGlideExtension.userProfileOptions(this, file, context);
  }

  /**
   * @see RetroGlideExtension#profileBannerOptions(BaseRequestOptions, File)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideOptions profileBannerOptions(@NotNull File file) {
    return (GlideOptions) RetroGlideExtension.profileBannerOptions(this, file);
  }
   ...
   */
  @CheckResult
  public static GlideOptions artistImageOptionsOf(@NotNull Object o) {
    return new GlideOptions().artistImageOptions(o);
  }
   ...
   */
  @CheckResult
  public static GlideOptions songCoverOptionsOf(@NotNull Song song,
      @org.jetbrains.annotations.Nullable Object o) {
    return new GlideOptions().songCoverOptions(song, o);
  }
   ...
   */
  @CheckResult
  public static GlideOptions simpleSongCoverOptionsOf(@NotNull Song song,
      @org.jetbrains.annotations.Nullable Object o) {
    return new GlideOptions().simpleSongCoverOptions(song, o);
  }
   ...
   */
  @CheckResult
  public static GlideOptions albumCoverOptionsOf(@NotNull Album album,
      @org.jetbrains.annotations.Nullable Object o) {
    return new GlideOptions().albumCoverOptions(album, o);
  }
   ...
   */
  @CheckResult
  public static GlideOptions userProfileOptionsOf(@NotNull File file, @NotNull Context context) {
    return new GlideOptions().userProfileOptions(file, context);
  }
   ...
   */
  @CheckResult
  public static GlideOptions profileBannerOptionsOf(@NotNull File file) {
    return new GlideOptions().profileBannerOptions(file);
  }
}
